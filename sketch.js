...
function setup()
 {
  ...
  chain = new Chain(shooter.body,{x:600,y:200})
    ...
    //bottom blocks
      ...
      //bottomabove blocks
      block6 = new Block(150,200,50,50)
       block7 = new Block(200,200,50,50)
       block8 = new Block(250,200,50,50)
       //middleblocks
       block9 = new Block(150,50,50,50)
       block10 = new Block(250,50,50,50)
       block11 = new Block(200,10,100,30)
       block12 = new Block(200,0,50,50)
